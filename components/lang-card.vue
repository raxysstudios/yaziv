    ...
    <NuxtLink :to="`/?lang=${lang.id}`" class="group">
        <div class="flex p-2 gap-2 overflow-clip items-center">
            <img :src="flagUrl" :alt="lang.id"
                class="mr-2 object-cover size-7 rounded-full group-hover:scale-110 group-active:scale-100 border ring-slate-300 group-hover:ring-offset-2 group-hover:ring">
